...
#
# Filename    : xlx_ku_mgt_ip_10g24.sh
...
#
# Generated by Vivado on Wed Oct 23 12:02:09 CEST 2019
# SW Build 2405991 on Thu Dec  6 23:36:41 MST 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: xlx_ku_mgt_ip_10g24.sh [-help]
# usage: xlx_ku_mgt_ip_10g24.sh [-lib_map_path]
# usage: xlx_ku_mgt_ip_10g24.sh [-noclean_files]
# usage: xlx_ku_mgt_ip_10g24.sh [-reset_run]
#
...
# executing this script. Please type 'xlx_ku_mgt_ip_10g24.sh -help' for more information.
#
...
# Script info
echo -e "xlx_ku_mgt_ip_10g24.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../../mgt/10g24/sim/gtwizard_ultrascale_v1_7_gthe3_channel.v" \
    "$ref_dir/../../../../../mgt/10g24/sim/xlx_ku_mgt_ip_10g24_gthe3_channel_wrapper.v" \
    "$ref_dir/../../../../../mgt/10g24/sim/xlx_ku_mgt_ip_10g24_gtwizard_gthe3.v" \
    "$ref_dir/../../../../../mgt/10g24/sim/xlx_ku_mgt_ip_10g24_gtwizard_top.v" \
    "$ref_dir/../../../../../mgt/10g24/sim/xlx_ku_mgt_ip_10g24.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.xlx_ku_mgt_ip_10g24 xil_defaultlib.glbl -o xlx_ku_mgt_ip_10g24_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./xlx_ku_mgt_ip_10g24_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./xlx_ku_mgt_ip_10g24.sh -help\" for more information)\n"
        exit 1
      fi
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/software/lpGBT/lpgbt-fpga-kcu105/Vivado/lpgbt-fpga-kcu105-10g24.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key xlx_ku_mgt_ip_10g24_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc xlx_ku_mgt_ip_10g24_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./xlx_ku_mgt_ip_10g24.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: xlx_ku_mgt_ip_10g24.sh [-help]\n\
Usage: xlx_ku_mgt_ip_10g24.sh [-lib_map_path]\n\
Usage: xlx_ku_mgt_ip_10g24.sh [-reset_run]\n\
Usage: xlx_ku_mgt_ip_10g24.sh [-noclean_files]\n\n\
