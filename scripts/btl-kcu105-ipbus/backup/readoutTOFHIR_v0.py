...
if __name__ == '__main__':
    ...
    nWord = 5
    MEM=TOFHIR_status.readBlock(int(nWord));
    hw.dispatch();
    # print result
    print("e-port 15 ", (MEM[0]), "Hz")
    print("e-port 16 ", (MEM[1]), "Hz")
    print("e-port 17 ", (MEM[2]), "Hz")
    print("e-port 18 ", (MEM[3]), "Hz")
    print("e-port 20 ", (MEM[4]), "Hz")
